...
class Core(Base):
    ...
    async def login(self, amp_user: str, amp_password: str, token: str = "", rememberME: bool = False, format_data: Union[bool, None] = None) -> LoginResults:
        ...
        result: Any = await self._call_api(api='Core/Login', parameters=parameters, format_data=format_data, format=LoginResults)
        return result
    ...
    async def get_api_spec(self) -> dict[Any, Any]:
        ...
        * See `docs/api_spec.md`
        ...
        await self._connect()
        result: Any = await self._call_api(api='Core/GetAPISpec')
        return result
    ...
    async def get_updates(self, format_data: Union[bool, None] = None) -> Updates:
        ...
        await self._connect()
        result: Any = await self._call_api(api='Core/GetUpdates', format_data=format_data, format=Updates)
        return result
    ...
    async def start_application(self, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        """
        await self._connect()
        result: Any = await self._call_api(api='Core/Start', format_data=format_data, format=ActionResult)
        return result

    @deprecated("Function overlap with `ADSModule`.start_instance()`, Please use `start_application()` instead.", stacklevel=2)
    async def start_instance(self, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        """
        import warnings
        warnings.warn(message="Core.start_instance() is deprecated and scheduled for "
                      "removal in a future version. Use Core.start_application() instead to start your Instance application.",
                      category=DeprecationWarning,
                      stacklevel=2)
        return await self.start_application(format_data=format_data)
    ...
    @deprecated("Function overlap with `ADSModule.stop_instance()`, Please use `stop_application()` instead.", stacklevel=2)
    async def stop_instance(self) -> None:
        ...
        """
        import warnings
        warnings.warn(message="Core.stop_instance() is deprecated and scheduled for "
                      "removal in a future version. Use Core.stop_application() instead to stop your Instance application.",
                      category=DeprecationWarning,
                      stacklevel=2)
        return await self.stop_application()

    @deprecated("Function overlap with `ADSModule.restart_instance()`, please use `stop_application()` instead.", stacklevel=2)
    async def restart_instance(self, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        """
        import warnings
        warnings.warn(message="Core.restart_instance() is deprecated and scheduled for "
    ...
    async def restart_application(self, format_data: Union[bool, None] = None):
        """
        Restarts the Instances Application (eg. Minecraft Server, Source Server, Palworld Server, etc.)
        ...
        """
        await self._connect()
        result: Any = await self._call_api(api='Core/Restart', format_data=format_data, format=ActionResult)
        return result

    @deprecated("Function overlap with `ADSModule.kill_instance()`, please use `kill_application()` instead.", stacklevel=2)
    async def kill_instance(self) -> None:
        ...
        """
        import warnings
        warnings.warn(message="Core.kill_instance() is deprecated and scheduled for "
    ...
    async def get_status(self, format_data: Union[bool, None] = None) -> AppStatus:
        ...
        await self._connect()
        result: Any = await self._call_api(api='Core/GetStatus', format_data=format_data, format=AppStatus)
        return result
    ...
    async def get_user_list(self, format_data: Union[bool, None] = None) -> list[Players]:
        ...
        await self._connect()
        result: Any = await self._call_api(api='Core/GetUserList', format_data=format_data, format=Players, _use_from_dict=False, _auto_unpack=False)
        return result
    ...
    async def get_schedule_data(self, format_data: Union[bool, None] = None) -> ScheduleData:
        ...
        await self._connect()
        result: Any = await self._call_api(api='Core/GetScheduleData', format_data=format_data, format=ScheduleData)
        return result
    ...
    async def get_active_amp_sessions(self, format_data: Union[bool, None] = None) -> list[Session]:
        ...
        **Requires ADS**
        ...
        await self._connect()
        result: Any = await self._call_api(api='Core/GetActiveAMPSessions', format_data=format_data, format=Session, _use_from_dict=False)
        return result
    ...
    async def get_amp_user_info(self, name: str, format_data: Union[bool, None] = None) -> User:
        ...
        result: Any = await self._call_api(api='Core/GetAMPUserInfo', parameters=parameters, format_data=format_data, format=User, _use_from_dict=False)
        return result
    ...
    async def create_role(self, name: str, as_common_role: bool = False, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='Core/CreateRole', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_role(self, role_id: str, format_data: Union[bool, None] = None) -> Role:
        ...
        result: Any = await self._call_api(api='Core/GetRole', parameters=parameters, format_data=format_data, format=Role)
        return result
    ...
    async def set_amp_user_role_membership(self, user_id: str, role_id: str, is_member: bool, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='Core/SetAMPUserRoleMembership', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def set_amp_role_permission(self, role_id: str, permission_node: str, enabled: Union[None, bool], format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='Core/SetAMPRolePermission', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_settings_spec(self) -> dict[str, Any]:
        ...
        await self._connect()
        result: Any = await self._call_api(api='Core/GetSettingsSpec')
        return result
    ...
    async def get_config(self, node: str, format_data: Union[bool, None] = None) -> SettingSpec:
        ...
        result: Any = await self._call_api(api="Core/GetConfig", parameters=parameters, format_data=format_data, format=SettingSpec)
        return result
    ...
    async def get_configs(self, nodes: list[str], format_data: Union[bool, None] = None) -> list[SettingSpec]:
        ...
        result: Any = await self._call_api(api="Core/GetConfigs", parameters=parameters, format_data=format_data, format=SettingSpec)
        return result
    ...
    async def get_update_info(self, format_data: Union[bool, None] = None) -> UpdateInfo:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetUpdateInfo", format_data=format_data, format=UpdateInfo)
        return result
    ...
    async def get_all_amp_user_info(self, format_data: Union[bool, None] = None) -> list[User]:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetAllAMPUserInfo", format_data=format_data, format=User, _use_from_dict=False)
        return result
    ...
    async def get_audit_log_entries(self, before: float, count: int, format_data: Union[bool, None] = None) -> list[AuditLogEntry]:
        ...
        result: Any = await self._call_api(api="Core/GetAuditLogEntries", parameters=parameters, format_data=format_data, format=AuditLogEntry, _use_from_dict=False)
        return result

    # Core.RunSecurityCheck:Parameters:ReturnTypeName: IEnumerable<JObject>IsComplexType: True
    ...
    async def get_setting_spec(self, format_data: Union[bool, None] = None) -> list[SettingSpec]:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetSettingsSpec", format_data=format_data, format=SettingSpec)
        return result
    ...
    async def refresh_setting_value_list(self, node: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/RefreshSettingValueList", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def refresh_settings_source_cache(self, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/RefreshSettingsSourceCache", format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_provision_spec(self, format_data: Union[bool, None] = None) -> list[SettingSpec]:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetProvisionSpec", format_data=format_data, format=SettingSpec)
        return result
    ...
    async def set_config(self, node: str, value: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/SetConfig", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def activate_amp_license(self, license_key: str, query_only: bool = False, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/ActivateAMPLicence", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_role_data(self, format_data: Union[bool, None] = None) -> list[Role]:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetRoleData", format_data=format_data, format=Role)
        return result
    ...
    async def delete_role(self, role_id: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/DeleteRole", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def rename_role(self, role_id: str, new_name: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/RenameRole", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def add_event_trigger(self, trigger_id: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/AddEventTrigger", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def run_event_trigger_immediately(self, trigger_id: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/RunEventTriggerImmediately", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_time_interval_trigger(self, id: str, format_data: Union[bool, None] = None) -> TimedTrigger:
        ...
        result: Any = await self._call_api(api="Core/GetTimeIntervalTrigger", parameters=parameters, format_data=format_data, format=TimedTrigger)
        return result
    ...
    async def edit_interval_trigger(self, id: str, months: int, days: int, hours: int, minutes: int, days_of_month: int,
        ...
        result: Any = await self._call_api(api="Core/EditIntervalTrigger", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def set_trigger_enabled(self, id: str, enabled: bool, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/SetTriggerEnabled", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def add_task(self, trigger_id: str, method_id: str, parameter_mapping: dict[str, str], format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/AddTask", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def edit_task(self, trigger_id: str, task_id: str, parameter_mapping: dict[str, str], format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/EditTask", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def change_task_order(self, trigger_id: str, task_id: str, new_order: int, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/ChangeTaskOrder", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def delete_task(self, trigger_id: str, task_id: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/DeleteTask", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def delete_trigger(self, trigger_id: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/DeleteTrigger", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_amp_users_summary(self, format_data: Union[bool, None] = None) -> list[Login_UserInfo]:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetAMPUsersSummary", format_data=format_data, format=Login_UserInfo)
        return result
    ...
    async def create_user(self, username: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/CreateUser", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def delete_user(self, username: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/DeleteUser", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def update_user_info(self, user_name: str, disabled: bool = False, password_expires: bool = False, cannot_change_password: bool = False,
        ...
        result: Any = await self._call_api(api="Core/UpdateUserInfo", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_webauthn_challenge(self, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetWebauthnChallenge", format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_webauthn_credential_ids(self, username: str, format_data: Union[bool, None] = None) -> list[Any]:
        ...
        result: Any = await self._call_api(api="Core/GetWebauthnCredentialIDs", parameters=parameters, format_data=format_data)
        return result
    ...
    async def webauthn_register(self, attestation_object: str, client_data_json: str, description: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/WebauthnRegister", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def revoke_webauthn_credential(self, id: int, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/RevokeWebauthnCredential", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def update_account_info(self, email_address: str, two_factor_pin: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/UpdateAccountInfo", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def enable_two_factor(self, username: str, password: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/EnableTwoFactor", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def confirm_two_factor_setup(self, username: str, two_factor_code: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/ConfirmTwoFactorSetup", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def disable_two_factor(self, password: str, two_factor_code: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/DisableTwoFactor", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def reset_user_password(self, username: str, new_password: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/ResetUserPassword", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def delete_instance_users(self, instance_id: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        results: Any = await self._call_api(api="Core/DeleteInstanceUsers", parameters=parameters, format_data=format_data, format=ActionResult)
        return results
    ...
    async def change_user_password(self, username: str, old_password: str, new_password: str, two_factor_pin: str = "", format_data: Union[bool, None] = None) -> ActionResult:
        ...
        results: Any = await self._call_api(api="Core/ChangeUserPassword", parameters=parameters, format_data=format_data, format=ActionResult)
        return results
    ...
    async def get_tasks(self, format_data: Union[bool, None] = None) -> list[RunningTask]:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetTasks", format_data=format_data, format=RunningTask)
        return result
    ...
    async def get_port_summaries(self, format_data: Union[bool, None] = None) -> list[Port]:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetPortSummaries", format_data=format_data, format=Port)
    ...
    async def cancel_task(self, task_id: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/CancelTask", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def dismiss_task(self, task_id: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api="Core/DismissTask", parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def dismiss_all_tasks(self, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/DismissAllTasks", format_data=format_data, format=ActionResult)
        return result
    ...
    async def update_application(self, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/UpdateApplication", format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_module_info(self, format_data: Union[bool, None] = None) -> Module:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetModuleInfo", format_data=format_data, format=Module)
        return result
    ...
    async def get_authentication_requirements(self, username: str, format_data: Union[bool, None] = None) -> list[Any]:
        ...
        result: Any = await self._call_api(api="Core/GetAuthencationRequirements", parameters=parameters, format_data=format_data)
        return result
    ...
    async def update_amp_instance(self) -> None:
        ...
        * Doesn't work on any other instance at this time.
    ...
    async def get_diagnostics_info(self, format_data: Union[bool, None] = None) -> Diagnostics:
        ...
        await self._connect()
        result: Any = await self._call_api(api="Core/GetDiagnosticsInfo", format_data=format_data, format=Diagnostics, _use_from_dict=False, _auto_unpack=False)
        return result
