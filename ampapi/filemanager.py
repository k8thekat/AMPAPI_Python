...
class FileManagerPlugin(Base):
    ...
    async def copy_file(self, origin: str, target_directory: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/CopyFile', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def rename_file(self, file_name: str, new_file_name: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/RenameFile', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def rename_directory(self, old_directory: str, new_directory_name: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/RenameDirectory', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def get_directory_listing(self, directory: str = "", format_data: Union[bool, None] = None) -> list[Directory]:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/GetDirectoryListing', parameters=parameters, format_data=format_data, format=Directory, _use_from_dict=False)
        return result
    ...
    async def get_file_chunk(self, file_name: str, position: int, length: int, format_data: Union[bool, None] = None) -> FileChunk:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/GetFileChunk', parameters=parameters, format_data=format_data, format=FileChunk)
        return result
    ...
    async def write_file_chunk(self, file_name: str, data: str, offset: int, final_chunk: bool, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/WriteFileChunk', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def trash_directory(self, directory_name: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        * See `FileManagerPlugin.emptyTrash()`.
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/TrashDirectory', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def trash_file(self, file_name: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/TrashFile', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def empty_trash(self, trash_directory_name: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/EmptyTrash', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def calculate_file_md5_sum(self, file_path: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/CalculateFileMD5Sum', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def change_exclusion(self, modify_path: str, as_directory: bool, exclude: bool, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/ChangeExclusion', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def create_archive(self, path_to_archive: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/CreateArchive', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def extract_archive(self, archive_path: str, destination_path: str | None = None, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/ExtractArchive', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def read_file_chunk(self, file_name: str, offset: int, chunk_size: int | None = None, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/ReadFileChunk', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def download_file_from_url(self, source: str, target_directory: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/DownloadFileFromURL', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
    ...
    async def create_directory(self, new_path: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='FileManagerPlugin/CreateDirectory', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
