...
class MinecraftModule(Base):
    ...
    def MConly(func):
        ...
        async def wrapper_MConly(self: Self, *args, **kwargs) -> bool:
            if self.Module == "Minecraft":
                return await func(self, *args, **kwargs)
            else:
                raise RuntimeError(self.MINECRAFT_ONLY)
        return wrapper_MConly
    ...
    async def mc_buk_get_popular_plugins(self, format_data: Union[bool, None] = None) -> list[BukkitPlugin]:
        ...
        await self._connect()
        result: Any = await self._call_api(api='MinecraftModule/BukGetPopularPlugins', format_data=format_data, format=BukkitPlugin)
        return result
    ...
    async def mc_buk_get_plugins_for_category(self, category_id: str, page_number: int = 1, page_size: int = 10, format_data: Union[bool, None] = None) -> list[BukkitPlugin]:
        ...
        result: Any = await self._call_api(api='MinecraftModule/BukGetPluginsForCategory', parameters=parameters, format_data=format_data, format=BukkitPlugin)
        return result
    ...
    async def mc_buk_get_plugin_info(self, plugin_id: int, format_data: Union[bool, None] = None) -> Any:
        ...
        result: Any = await self._call_api(api='MinecraftModule/BukGetPluginInfo', parameters=parameters, format_data=format_data)
        return result
    ...
    async def mc_buk_get_installed_plugins(self, format_data: Union[bool, None] = None) -> list[BukkitPlugin]:
        ...
        await self._connect()
        result: Any = await self._call_api(api='MinecraftModule/BukGetInstalledPlugins', format_data=format_data, format=BukkitPlugin)
        return result
    ...
    async def mc_buk_get_install_update_plugin(self, plugin_id: int, format_data: Union[bool, None] = None) -> RunningTask:
        ...
        result: Any = await self._call_api(api='MinecraftModule/BukGetInstallUpdatePlugin', parameters=parameters, format_data=format_data, format=RunningTask)
        return result
    ...
    async def mc_buk_get_search(self, query: str, page_number: int = 0, page_size: int = 10, format_data: Union[bool, None] = None) -> list[BukkitPlugin]:
        ...
        result: Any = await self._call_api(api='MinecraftModule/BukGetSearch', parameters=parameters, format_data=format_data, format=BukkitPlugin)
        return result
    ...
    async def mc_get_op_whitelist(self, format_data: Union[bool, None] = None) -> OPWhitelist:
        ...
        await self._connect()
        result: Any = await self._call_api(api='MinecraftModule/GetOPWhitelist', format_data=format_data, format=OPWhitelist)
        return result
    ...
    async def mc_get_whitelist(self, format_data: Union[bool, None] = None) -> list[MCUser]:
        ...
        await self._connect()
        result: Any = await self._call_api(api='MinecraftModule/GetWhitelist', format_data=format_data, format=MCUser)
        return result
    ...
    async def mc_load_op_list(self, format_data: Union[bool, None] = None) -> list[OPList]:
        ...
        await self._connect()
        result: Any = await self._call_api(api='MinecraftModule/LoadOPList', format_data=format_data, format=OPList)
        return result
    ...
    async def mc_add_to_whitelist(self, user_or_uuid: str, format_data: Union[bool, None] = None) -> ActionResult:
        ...
        result: Any = await self._call_api(api='MinecraftModule/AddToWhitelist', parameters=parameters, format_data=format_data, format=ActionResult)
        return result
